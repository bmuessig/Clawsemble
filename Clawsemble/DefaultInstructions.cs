...
namespace Clawsemble
{
    public static class DefaultInstructions
    {
        public static List<InstructionSignature> CompileList()
        {
            ...
            instrs.Add(new InstructionSignature("mdp", 0xc, new InstructionArgument(InstructionArgumentType.String)));
            instrs.Add(new InstructionSignature("mdl", 0xd, new InstructionArgument(InstructionArgumentType.Module)));
            instrs.Add(new InstructionSignature("mdv", 0xe, new InstructionArgument(InstructionArgumentType.Module)));
            instrs.Add(new InstructionSignature("lrl", 0xf, new InstructionArgument(InstructionArgumentType.String)));
            ...
            instrs.Add(new InstructionSignature("lc", 0x13, new InstructionArgument(InstructionArgumentType.Number)));
            instrs.Add(new InstructionSignature("ld", 0x14, new InstructionArgument(InstructionArgumentType.Byte)));
            ...
            instrs.Add(new InstructionSignature("swf", 0x19, new InstructionArgument(InstructionArgumentType.Byte)));
            instrs.Add(new InstructionSignature("lx", 0x1a, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
            instrs.Add(new InstructionSignature("lxd", 0x1b));
            instrs.Add(new InstructionSignature("lxb", 0x1c, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
            instrs.Add(new InstructionSignature("lxbd", 0x1d));
            instrs.Add(new InstructionSignature("px", 0x1e, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
            instrs.Add(new InstructionSignature("pxd", 0x1f));
            instrs.Add(new InstructionSignature("pxb", 0x20, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
            instrs.Add(new InstructionSignature("pxbd", 0x21));
            instrs.Add(new InstructionSignature("xc", 0x22, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
            instrs.Add(new InstructionSignature("xcb", 0x23, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
            instrs.Add(new InstructionSignature("xcd", 0x24));
            instrs.Add(new InstructionSignature("xci", 0x25, new InstructionArgument(InstructionArgumentType.Array)));
            instrs.Add(new InstructionSignature("xs", 0x26, new InstructionArgument(InstructionArgumentType.Byte)));
            ...
            instrs.Add(new InstructionSignature("xpi", 0x31, new InstructionArgument(InstructionArgumentType.Byte)));
            ...
            instrs.Add(new InstructionSignature("xfc", 0x36, new InstructionArgument(InstructionArgumentType.Byte)));
            instrs.Add(new InstructionSignature("xmn", 0x37, new InstructionArgument(InstructionArgumentType.Byte)));
            instrs.Add(new InstructionSignature("xmb", 0x38, new InstructionArgument(InstructionArgumentType.Byte)));
            instrs.Add(new InstructionSignature("xmd", 0x39));
            instrs.Add(new InstructionSignature("xmcn", 0x3a, new InstructionArgument(InstructionArgumentType.Array)));
            instrs.Add(new InstructionSignature("xmcb", 0x3b, new InstructionArgument(InstructionArgumentType.ByteArray)));
            instrs.Add(new InstructionSignature("xmcd", 0x3c));
            instrs.Add(new InstructionSignature("cnb", 0x3d));
            instrs.Add(new InstructionSignature("cnc", 0x3e, new InstructionArgument(InstructionArgumentType.UnsignedNumber)));
